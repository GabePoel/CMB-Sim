...
u = Universe(0.1, 8, mpG=False, mpEvolve=True, mpE=False, mpMeasure=False, mpInteract=False)
u.add_electrons(50)
u.add_protons(50)
...
for i in tqdm(range(steps)):
    ...
    u.next_size = u.size * 1.01
    u.evolve(time_step)
    draw_universe(u, name='Quick Exponential', step=i, nofig=True)
...
plt.legend()
plt.savefig('Quick Exponential Out.png', dpi=300)